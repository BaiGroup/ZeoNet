...
from dataset.image_dataset import ZeoImgsDataset
from trainer.base_trainer import BaseTrainer

class ImageTrainer(BaseTrainer):
    """Specialized trainer for 2D multi-view image representations"""
    ...
    def _setup_training_components(self):
        ...
        train_set = ZeoImgsDataset(root_dir=self.config.loader.data_path, 
    ...
    def _train_epoch(self):
        ...
        for batch_idx, sample in enumerate(self.train_loader):
            ...
            data = data.reshape(-1,3,self.config.loader.grid_size,self.config.loader.grid_size)
